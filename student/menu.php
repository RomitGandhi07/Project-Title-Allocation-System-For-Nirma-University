...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index.php" class="brand-link">
        ...
        style="opacity: .8">
        <span class="brand-text font-weight-light"><?php echo $_SESSION['studentusername']; ?></span>
    </a>
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="choiceFilling.php" class="nav-link">
                        <i class="nav-icon fa fa-plus-circle"></i>
                        <p>Choice Filling</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="ownTitle.php" class="nav-link">
                        <i class="nav-icon fa fa-plus-circle"></i>
                        <p>Own Titles</p>
                    </a>
                </li>
