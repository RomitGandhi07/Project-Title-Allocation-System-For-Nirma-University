...
<html>
    <head>
        ...
        <title>Student | Email Confirmation</title>
        ...
        <div class="box effect1">
            <form action="" method="post">
                ...
                <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="email" placeholder="Email" name="email" value="<?php session_start(); echo $_SESSION['susername']."@nirmauni.ac.in"; ?>" readonly>
