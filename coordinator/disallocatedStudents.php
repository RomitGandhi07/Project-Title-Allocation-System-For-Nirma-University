...
$productResult = $db_handle->runQuery("SELECT roll_no,partner_roll_no FROM choice_filling WHERE roll_no NOT IN (SELECT student_roll_no FROM titles_allocated WHERE student_roll_no IS NOT NULL)");

if (isset($_POST["export"])) {
    $filename = "Disallocated Students.xls";
...
<head>
    ...
    <title>Coordinator | Disallocated Students</title>
